  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen py-20">
      ...
      <section className="flex flex-wrap justify-center md:mt-10 w-full gap-8 mb-16">
        ...
        <Image src={secure} width={80} height={80} alt="logo" className=" mx-auto mb-4"/>
        ...
        <div className="bg-white text-slate-500 px-8 py-10 max-w-md  w-96 md:mx-auto mx-3 shadow-lg  rounded-lg text-center">
        <Image src={responsive} width={80} height={80} alt="logo" className=" mx-auto mb-4"/>
          <h2 className="text-xl font-semibold mb-2">Acceso desde cualquier dispositivo</h2>
          <p className="text-base">Accede rápidamente a tus cuentas desde tu computador o dispositivo movil.</p>
        </div>
        <div className="bg-white text-slate-500 px-8 py-10 max-w-md  w-96 md:mx-auto mx-3 shadow-lg  rounded-lg text-center">
        <Image src={setting} width={80} height={80} alt="logo" className=" mx-auto mb-4"/>
